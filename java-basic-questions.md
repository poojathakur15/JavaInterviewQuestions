...
main():                         
┌─────────────────┐            ┌──────────────────┐
│ x = 10          │            │ Person object 1: │
│ y = 20          │            │ name: "John"     │
│ p1 = ref ───────┼───────────→│ age: 30          │
│ p2 = ref ───────┼──┐         └──────────────────┘
└─────────────────┘  │         
                     │         ┌──────────────────┐
calculate():         └────────→│ Person object 2: │
┌─────────────────┐            │ name: "Jane"     │
│ a = 10          │            │ age: 28          │
│ b = 20          │            └──────────────────┘
│ sum = 30        │
...
└──────────┘
     ...
     ↓
modifyPrimitive() method:
┌──────────┐
│ num = 10 │  ← This is a COPY
└──────────┘
     │
     ↓ (modified to 20)
┌──────────┐
│ num = 20 │  ← Only the copy changes
└──────────┘
...
### Shallow Copy Memory Visualization
...
│ name: "Alice"│ ───→│ city: "NY"      │←─── Both point to
│ age: 25     │     │ country: "USA"  │     SAME object
│ address: ───┼──┐  └─────────────────┘
└─────────────┘  │           ↑
                 └───────────┤
┌─────────────┐              │
...
**Total Document:** 7 major parts covering complete Java OOP, Advanced concepts, Design Patterns, and Security! 🎉
